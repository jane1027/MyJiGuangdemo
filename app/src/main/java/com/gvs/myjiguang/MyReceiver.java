...
public class MyReceiver extends BroadcastReceiver {
   ...
   //     	processCustomMessage(context, bundle);
			//推送的标题
			String text1 = bundle.getString(JPushInterface.EXTRA_MESSAGE);
			//json 可选选项-
			...
			//打开一个Activity的Intent
			Intent intent1= new Intent(context, PopWinActivity.class);
...
//v4->向下兼容
			NotificationCompat.Builder mBuilder =
					new NotificationCompat.Builder(context)
							.setSmallIcon(R.drawable.gvs)
							.setContentTitle("视声集团与你同在")
							.setContentText(text1)
							.setTicker("视声给你送了大福利，请注意查收！")
							;
